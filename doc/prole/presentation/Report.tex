...
\institute[] % (optional)
{
  ...
  \begin{frame}[fragile]{DP Framework: Haskell}
    ...
    \tiny
      \begin{equation*}
          \boxed{
           \begin{aligned}
          V &= \{DP,S_r,S_k,G,F_b,CH,CH_s,\text{\mintinline{haskell}{Source}},\text{\mintinline{haskell}{Generator}},\text{\mintinline{haskell}{Sink}},\text{\mintinline{haskell}{FeedbackChannel}},\text{\mintinline{haskell}{Type}},\text{\mintinline{haskell}{Eof}},\text{\mintinline{haskell}{:=>}},\text{\mintinline{haskell}{:<+>}}\},\\
  ...
  \begin{frame}[fragile]{DP Framework: Haskell}
    \begin{itemize}
      \item If we define a \textbf{DP} Language that is Recognize by the Grammar
    \end{itemize}    
  \end{frame}
  ...
  \begin{frame}[fragile]{DP Framework: Haskell}
    \begin{itemize}
      \item If we define a \textbf{DP} Language that is Recognize by the Grammar
      \item It is Compile time checked by the Grammar (\textit{Type-safe})
    \end{itemize}    
  \end{frame}
  ...
  \begin{frame}[fragile]{DP Framework: Haskell}
    ...
    \begin{exampleblock}{Type Level DSL}
      \begin{minted}[fontsize=\tiny,highlightlines={7-17}]{shell}      
...
mkDP @DPExample
  ...
  \begin{frame}[fragile]{DP Framework: Haskell}
    \begin{itemize}
      \item Otherwise the Compiler warning us about \textbf{Grammar Verification Error}
    \end{itemize}    
  \end{frame}
  ...
  \begin{frame}[fragile]{DP Framework: Haskell}
    ...
    \begin{minted}[fontsize=\tiny,highlightlines={8-17},highlightcolor=titaniumyellow]{shell}      
...
type DPExample =
  ...
  \begin{frame}[fragile]{DP Framework: Haskell}
    \begin{block}{IDL}
      \begin{minted}[fontsize=\tiny,highlightlines={7-11}]{shell}      
ghci> type DPExample = Source (Channel (Int :<+> Eof)) :=> Generator (Channel (Int :<+> Eof)) :=> Sink
type DPExample :: *
type DPExample =
  Source (Channel (Int :<+> Eof))
...
withSource @DPExample
  ...
  \begin{frame}[fragile]{DP Framework: Haskell}
    \begin{block}{IDL}
      \begin{minted}[fontsize=\tiny,highlightlines={7-9}]{shell}      
ghci> :t withSource @DPExample
withSource @DPExample
  :: forall k (st :: k).
      (WriteChannel Int -> DP st ())
...
source' :: forall k (st :: k). Stage (WriteChannel Int -> DP st ())
  ...
  \begin{frame}[fragile]{DP Framework: Haskell}
    \begin{block}{IDL}
      \begin{minted}[fontsize=\tiny,highlightlines={11-16}]{shell}      
ghci> :t withSource @DPExample
withSource @DPExample
  :: forall k (st :: k).
      (WriteChannel Int -> DP st ())
...
withGenerator @DPExample
  ...
  \begin{frame}[fragile]{$DP_{WCC}$: Computing $WCC$}
    \begin{block}{Program}
      \begin{minted}[fontsize=\tiny,highlightlines={5-6}]{haskell}      
...
program file = runDP $ mkDP @DPConnComp (source' file) generator' sink'
  ...
  \begin{frame}[fragile]{$DP_{WCC}$: Computing $WCC$}
    \begin{block}{Program}
      \begin{minted}[fontsize=\tiny,highlightlines={5-9}]{haskell}      
type DPConnComp = Source (Channel (Edge :<+> ConnectedComponents :<+> Eof))
:=> Generator (Channel (Edge :<+> ConnectedComponents :<+> Eof))
:=> Sink
...
program file = runDP $ mkDP @DPConnComp (source' file) generator' sink'  
  ...
  \begin{frame}[fragile]{$DP_{WCC}$: Computing $WCC$}
    \begin{block}{Program}
      \begin{minted}[fontsize=\tiny,highlightlines={5-7}]{haskell}      
type DPConnComp = Source (Channel (Edge :<+> ConnectedComponents :<+> Eof))
:=> Generator (Channel (Edge :<+> ConnectedComponents :<+> Eof))
:=> Sink
...
program file = runDP $ mkDP @DPConnComp (source' file) generator' sink'  
  ...
  \begin{frame}[fragile]{$DP_{WCC}$: Computing $WCC$}
    \begin{block}{Program}
      \begin{minted}[fontsize=\tiny,highlightlines={7-8,11-11}]{haskell}      
type DPConnComp = Source (Channel (Edge :<+> ConnectedComponents :<+> Eof))
:=> Generator (Channel (Edge :<+> ConnectedComponents :<+> Eof))
:=> Sink
...
program file = runDP $ mkDP @DPConnComp (source' file) generator' sink'
  ...
  \begin{frame}[fragile]{$DP_{WCC}$: Computing $WCC$}
    \begin{block}{Program}
      \begin{minted}[fontsize=\tiny,highlightlines={11-14}]{haskell}      
type DPConnComp = Source (Channel (Edge :<+> ConnectedComponents :<+> Eof))
:=> Generator (Channel (Edge :<+> ConnectedComponents :<+> Eof))
:=> Sink
...
program file = runDP $ mkDP @DPConnComp (source' file) generator' sink'
  ...
  \begin{frame}[fragile]{$DP_{WCC}$: Computing $WCC$}
    \begin{block}{Program}
      \begin{minted}[fontsize=\tiny,highlightlines={7-12,20-28}]{haskell}      
actor1 :: Edge
       -> ReadChannel Edge
       -> ReadChannel ConnectedComponents
       -> WriteChannel Edge
 ...
 where
  ...
  \begin{frame}[fragile]{$DP_{WCC}$: Computing $WCC$}
    \begin{block}{Demo Time}
      \movie[width=12cm,height=4.5cm,poster,externalviewer]{}{screen_2.mp4}
    \end{block}
  \end{frame}
