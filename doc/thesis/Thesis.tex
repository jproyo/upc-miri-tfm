...
\title{An algorithm for incrementally enumerating bi-triangles in large bipartite networks}
...
One of the metrics that reflect properly if the relationships are strong on particular elements of sets are bi-triangles of bipartite graphs. 
Having an algorithm that enumerates bi-triangles incrementally that matches specific criteria is extremely useful for real networks and scenarios like expressed before. 
