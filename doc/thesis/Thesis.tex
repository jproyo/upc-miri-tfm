...
Having an algorithm that enumerates bitriangles incrementally that matches specific criteria is extremely useful for real networks and scenarios like expressed before. 
...
we provide an algorithm for enumerating bitriangles in a bipartite graph given particular criteria. 
