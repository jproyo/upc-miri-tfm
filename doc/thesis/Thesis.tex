...
This metric also allows conducting relationship analysis on Bipartite Networks.
Some related work has been done for counting Bitriangles in Bipartite Graph lately. 
Counting is extremely useful for calculating metrics such as clustering coefficient, social analysis, or bitriangles based-communities, there are some use cases that requires the capability to know structural information of those Bitriangles, 
