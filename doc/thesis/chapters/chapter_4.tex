\chapter{An Incremental algorithm to enumerate Bi-Triangles using DP}
...
\end{definition}
%
%\begin{definition}[Aggregated double-wedge]  //Definición original de Juan Pablo
...
\end{definition}
%
%\begin{definition}[Aggregated bi-triangle] //Definición original de Juan Pablo
...
\caption{This actor tries to build a Set of all possible Aggregated double-wedges $\dw = \{\la (l,l'), U_t \ra\}$, which first component $l$ is the Parameter of the Filter}
\end{algorithm}
...
\caption{This actor try to build a Set of all possible Aggregated bi-triangles $\at = \{\la (l_l, l_m, l_u), U_t \ra\}$, , such that $l = l_l \lor l = l_u$, where $l$ is the Filter Parameter}
\end{algorithm}
...
\I{$\la (l_l, l_m, l_u), \la I,J,K \ra \ra$}
\I{$Q_V$}
...
\caption{Given a Set of Vertex Try to build the set of all possible bi-triangles based on Aggregated bi-triangles information in $\at$ param}
\end{algorithm}
...
\caption{Given a Set of Edges Try to build the set of all possible bi-triangles based on Aggregated bi-triangles information in $\at$ param}
\end{algorithm}
