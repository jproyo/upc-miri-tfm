...
During the research of this work, we have explored \acrlong{dp} as a model of computation to solve that problem using the described approach. 
...
Moreover, we have also shown how strong \acrlong{hs} behaves for implementing \acrlong{dp} for solving \acrlong{iebt}. 
