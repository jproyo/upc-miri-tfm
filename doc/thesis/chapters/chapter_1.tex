...
Moreover another important contribution and, the harvest of that contribution to \acrshort{prole21}, was the development and publication of a \acrshort{hs} Framework 
...
Finally, the novelty that provides an incremental algorithm for enumerating \acrshort{bt}, is a step forward on the field and opens new research path and improvements 
