...
\caption{\acrshort{bt} $(1,a,7,b,5,c,1)$}
\end{subfigure}
...
As we can see in \autoref{fig:bt-a-example}, the two possible \acrshort{bt} can be extracted from the \acrshort{abt} presented in \autoref{fig:agg-bt-example} are $(1,a,3,c,5,b,1)$ and $(1,a,7,b,5,c,1)$.
