...
Note that $\hat{U}_{(a,b,c)}=\{I,J,K\}$ does not contains disjoint sets according to \dref{def:abt}, because we are using a compressing mechanism similar as described in \cite{Lai}. 
}
