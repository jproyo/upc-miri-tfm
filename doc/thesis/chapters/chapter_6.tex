...
Following that, we can build the \acrlong{adwg} as we can see in \autoref{fig:agg-double-wedge-example} to continue building the structure that leads us to the \acrshort{bt}.
