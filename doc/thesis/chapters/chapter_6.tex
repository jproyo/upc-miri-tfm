...
Inside that \texttt{for} loop there is taking place 1 intersection and 2 set difference operations. Each of those operations are $O(m+n)$ where $m = n = |U|$ in the worst-case, since $W_l \subseteq U$ by \dref{def:awg}. 
