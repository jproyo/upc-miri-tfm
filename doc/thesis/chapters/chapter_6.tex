...
\caption[\acrshort{bt} $(u_1,l_l,u_2,l_u,u_3,l_m,u_1)$]{A \emph{bitriangle} $(u_1,l_l,u_2,l_u,u_3,l_m,u_1)$ formed by \emph{double-wedge} $(u_1,l_l,u_2,l_u,u_3)$ and connector \emph{wedge} $(u_1,l_m,u_3)$}
\end{subfigure}
...
In effect, if we assumed that $l_m > l_l$ and $l_m < l_u$, the \emph{wedge} $(u_1,l_m,u_3)$ together with the \emph{double-wedge} $(u_1,l_l,u_2,l_u,u_3)$ form a  a bitriangle.  
