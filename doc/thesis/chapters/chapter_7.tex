...
\begin{inparaenum}[]
      \item \mintinline[breaklines]{bash}{dyanmic-pipeline 0.3.2.0} \cite{dynamic-pipeline},
      \item \mintinline[breaklines]{bash}{bytestring 0.10.12.0} \cite{bytestring},
      \item \mintinline[breaklines]{bash}{containers 0.6.2.1} \cite{containers}, 
      \item \mintinline[breaklines]{bash}{relude 1.0.0.1} \cite{relude}
      \item and \mintinline[breaklines]{bash}{unagi-chan 0.4.1.3} \cite{unagi} 
  \end{inparaenum}. The use of \texttt{relude} library is because we disabled 
\mintinline[breaklines]{haskell}{Prelude} from the project with the language extension \mintinline[breaklines]{haskell}{NoImplicitPrelude} \cite{extensions}. 
