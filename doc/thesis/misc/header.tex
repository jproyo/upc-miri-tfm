...
\newacronym{iebt}{IEBT}{Algorithm for Incrementally Enumerating Bitriangles in Bipartite Network}
...
\newacronym{awg}{AWG}{Aggregated Wedge}
\newacronym{dwg}{DWG}{Double-wedge}
\newacronym{adwg}{ADWG}{Aggregated double-wedge}
\newacronym{abt}{ABT}{Aggregated Bi-triangle}
