...
\newacronym{dt}{dief$@$t}{Diefficiency Metric dief$@$t}
\newacronym{dk}{dief$@$k}{Diefficiency Metric dief$@$k}
\newacronym{dtkp}{diefpy}{Python package for computing diefficiency metrics dief@t and dief@k.}
