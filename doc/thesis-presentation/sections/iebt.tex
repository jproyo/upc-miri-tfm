...
\begin{frame}[fragile]{Algorithm for Incrementally Enumerating BT in BG}
  ...
  \begin{figure}
    \centering  
    \resizebox{1\textwidth}{!}{\inputtikz{btDP}}
  \end{figure}
\end{frame}
...
\begin{frame}[fragile]{Algorithm for Incrementally Enumerating BT in BG}
  ...
  \begin{figure}
    \centering  
    \resizebox{1\textwidth}{!}{\inputtikz{btDP_actor1}}
  \end{figure}
\end{frame}
                    ...
                    \Switch{$Q$}{
                          \Case{$\mathbb{P}(U + L)$}{
                                \If{$\mathbb{P}(U + L) \cap \{l_l, l_m, l_u\} \neq \emptyset \lor \mathbb{P}(U + L) \cap (I \cup J \cup K) \neq \emptyset$}{
                                      \HiLi$\btii \leftarrow \butV(\la (l_l, l_m, l_u), \la I,J,K \ra \ra), \mathbb{P}(U + L))$\\
...
\begin{frame}[fragile]{Algorithm for Incrementally Enumerating BT in BG}
  ...
  \begin{proof}[Proof. All Bitriangles can be enumerated]   
