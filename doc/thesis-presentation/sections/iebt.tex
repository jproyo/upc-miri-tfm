...
\begin{frame}[fragile]{Algorithm for Incrementally Enumerating BT in BG}
  ...
  \begin{table}[H]
    ...
    \begin{tabular}{c c}
     \begin{tabular}{l}\underline{\color{red}Aggregated Wedges}\end{tabular} & \begin{tabular}{l}\resizebox{5cm}{2cm}{\inputtikz{bipartite_awg_a}\inputtikz{bipartite_awg_b}\inputtikz{bipartite_awg_c}}\end{tabular}\\
     \begin{tabular}{l}\underline{\color{red}Aggregated Double Wedges}\end{tabular} & \begin{tabular}{l}\resizebox{4cm}{2cm}{\inputtikz{bipartite_adwg_a}}\end{tabular}\\
     \begin{tabular}{l}\underline{\color{red}Aggregated Bitriangles}\end{tabular} & \begin{tabular}{l}\resizebox{4cm}{2cm}{\inputtikz{bipartite_abt_a}}\end{tabular}\\
    \end{tabular}
    }
   \end{table}
\end{frame}
...
\begin{frame}[fragile]{Algorithm for Incrementally Enumerating BT in BG}
  ...
  \begin{tikzpicture}[overlay, remember picture]
    \node[xshift=-4cm,yshift=-5cm] at (current page.north east) {
      \resizebox{5cm}{2cm}{\inputtikz{bipartite_awg_a}\inputtikz{bipartite_awg_b}\inputtikz{bipartite_awg_c}}
    };
  \end{tikzpicture}
...
\begin{frame}[fragile]{Algorithm for Incrementally Enumerating BT in BG}
  \begin{center}
    \underline{\textbf{\texttt{actor4}: Process Query to Incrementally retrieve Bitriangles}}
  \end{center}
  \resizebox{!}{0.4\textheight}{  
    \begin{algorithm}[H]
